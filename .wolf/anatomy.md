...
- `README.md` — Project documentation (~1660 tok)
...
- `appsettings.json` (~518 tok)
- `Program.cs` — src/HrMcp.McpServer/Program.cs (~2850 tok)
...
- `JobDescriptionTools.cs` — src/HrMcp.McpServer/Tools/JobDescriptionTools.cs (~768 tok)
